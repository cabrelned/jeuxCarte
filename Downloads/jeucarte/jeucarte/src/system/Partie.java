 ...
 * Class qui est le model de la partie et aussi le gestionnaire de la partie
 */
public class Partie {
    ...
    int manche=0;
    String gangnant="";
    public String getGangnant() {
        return gangnant;
    }


    public void setGangnant(String gangnant) {
        this.gangnant = gangnant;
    }
    String partieDemarer="false";
    HashMap<String, ArrayList<Carte>> joueurListeCarte;

    /**
     * @param nbJoueur
     * methode de creation d'une partie avec le nombres de joeur passer en parametres
     */
    ...
    /**
     * @return
     * methode de creation du paquet de 104 cartes
     */

    public ArrayList<Carte> creerPaqueCartes(){
        ...
        System.out.println("paquet de carte creer");
        return listCarte;
    }
    ...
    /**
     * @param joueur
     * methode pour ajouter un joueur dans la liste des joueur de partie en cours
     */

    public void ajouterListeJoueurs(Joueur joueur){
        this.joueurs.add(joueur);
        System.out.println("joueur creer");
    }


    /**
     * methode qui permet de melanger un paquet de cartes 
     */
    public void melangerPaquet(){
        ...
        System.out.println("melanger carte");    
    }


    /**
     * methoodes qui permet de distribuer les carte aux differents joueur de la partie joueur par joueur
     */
    ...
    public void distribuerCarte(){
        ...
        System.out.println("carte patageter");          
    }


    /**
     * methode pour cree les quatre lignes de carte.
     */
    public void creerListeLigneCarte(){
        for(int j=0; j<4; j++){
            this.listeLigneCarte.add(new ArrayList<Carte>()); 
         } 
         System.out.println("carte liste ligne carte creer");
    }

    /**
     * @param i indice de la carte a retirer sur les 10 carte dans la main du joueur
     * @param j indice du joueur en question
     * methode pour mettre une carte face cacher
     */
    ...
    /**
     * methode qui permet de poser les quatres premiere cartes sur les differentes lignes
     */
    ...
    /**
     * @return
     * methode qui determine l'ordre a joueur des joueurs
     */
     ...
     * @param i
     * @return
     * methode qui calcule le nombre de tete de chaque ligne sur le tableau
     */
    ...
    /**
     * @param carte c'est la carte a placer sur une ligne des cartes
     * @return
     * methode qui choisier la ligne dans la quelle une carte doit etre poser selon la regle
     */
    public int choixDeLigne(Carte carte){
        ...
        for(int j=0; j<4; j++){
         ...
         if (listeLigneCartes.get(0)==carte) {
            // utilisateur peut recuperer une la ligne de son choix
    ...
    public void poserUneCarteSurTableau(int i,int j){
        ...
        System.out.println("carte poser sur la place correspondente");
    }
    /**
     * @param partie
     * initializer la partie 
     */
    ...
    /**
     * methode qui actualise le gagnants de la partie
     */
    public void setJoueurGagnant(){
      ...
      for(Joueur joueur : this.joueurs){
        ...
        if(nbTete<plusPetitNbTete){
            gangnant=joueur.getNom(); 
        }
      }
    //   partie avec resultat draw
      if (gangnant=="") {
        for(Joueur joueur : this.joueurs){
            joueur.setStatus("draw");
          }
      }
    // partie avec un vainquer
    if (gangnant!="") {
        for(Joueur joueur : this.joueurs){
            if (joueur.getNom()==gangnant) {
                joueur.setStatus("a gagner");
            }else{
    ...
    public String getPartieDemarer() {
        return partieDemarer;
    }
    public void setPartieDemarer(String partieDemarer) {
        this.partieDemarer = partieDemarer;
    }
